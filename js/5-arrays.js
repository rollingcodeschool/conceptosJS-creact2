...
const mostrarArreglos = (arreglo, titulo) => {
  ...
  arreglo.map((item, indice) =>
    document.write(`<li>${item} - posicion:${indice} </li>`)
  );
  document.write("</ol>");
};
...
document.write(
  `<p>Cantidad de elementos en el array de precios: ${precios.length}</p>`
);
document.write(
  `<p>Cantidad de elementos en el array de peliculas: ${peliculas.length}</p>`
);
...
mostrarPeliculas(
  `Agregamos 2 elementos al principio del array, peliculas: ${peliculas.length}`
);

//agregar un elemento al final del array
peliculas.push("furia de titanes");
document.write(
  `<h2>Agregamos 1 elemento al final del array, peliculas: ${peliculas.length}</h2>`
);
document.write("<ul>");
for (let i = 0; i < peliculas.length; i++) {
  document.write(`<li>${peliculas[i]}</li>`);
...
document.write(
  `<h2>Agregamos 1 elemento en el medio del array, peliculas: ${peliculas.length}</h2>`
);
document.write("<ul>");
for (let i = 0; i < peliculas.length; i++) {
  document.write(`<li>${peliculas[i]}</li>`);
...
peliculas[4] = "Cars 1";
document.write(
  `<h2>Modificamos el elemento de la posicion 4 del array, peliculas: ${peliculas.length}</h2>`
);
document.write("<ul>");
for (let i = 0; i < peliculas.length; i++) {
  document.write(`<li>${peliculas[i]}</li>`);
...
peliculas.shift();
document.write(
  `<h2>Borramos el primer elemento del array, peliculas: ${peliculas.length}</h2>`
);
document.write("<ul>");
for (let i = 0; i < peliculas.length; i++) {
  document.write(`<li>${peliculas[i]}</li>`);
...
peliculas.pop();
document.write(
  `<h2>Borramos el ultimo elemento del array, peliculas: ${peliculas.length}</h2>`
);
document.write("<ul>");
for (let i = 0; i < peliculas.length; i++) {
  document.write(`<li>${peliculas[i]}</li>`);
...
document.write(
  `<h2>Borramos el elemento de la posicion 4 del array, peliculas: ${peliculas.length}</h2>`
);
document.write("<ul>");
for (let i = 0; i < peliculas.length; i++) {
  document.write(`<li>${peliculas[i]}</li>`);
...
const encontreVengadores = peliculas.find(
  (itemPelicula) => itemPelicula === "Vengadores"
);
...
const posicionPeliVengadores = peliculas.findIndex(
  (item) => item === "Vengadores"
);
console.log(posicionPeliTitanic, posicionPeliVengadores);

document.write(
  `<p>Peli encontrada ${encontreTitanic}, esta en la posicion ${posicionPeliTitanic} del array </p>`
)
  //if(undefined)
  // if(encontreVengadores){
  ...
  //operador ternario ? :
  // (condicion logica) ? lo que deberia hacer si se cumple la condicion : lo que deberia hacer si no se cumple la condicion

 document.write(`${ (encontreVengadores)? `<p>Peli encontrada ${encontreVengadores}, esta en la posicion ${posicionPeliVengadores} del array </p>`: '<p>No encontramos la pelicula buscada</p>' }`)

//si quiero filtrar elemntos del array
peliculas.push("Shrek 3", "Shrek 4");
const sagaSherk = peliculas.filter((pelicula) =>
  pelicula.toLowerCase().includes("shrek")
);
